...
public class FunZone extends GameState{
	...
	public FunZone (GameStateManager gsm) {
		this.gsm = gsm;
		init();
	}
	...
	public void init() {
		...
		tileMap.loadMap("/maps/funLevel.map");
	...
	private void populateEnemies() {
		...
		PixelThug pt;
		Point[] points = new Point[] {new Point(200, 200), new Point(400, 200), new Point(600, 100), new Point(860, 200), new Point(1000, 100), new Point(1200, 100), new Point(1400, 100), new Point(1525, 200), new Point(1680, 200), new Point(1750, 100), new Point(1800, 200), new Point(2000, 100), new Point(2200, 100), new Point(2400, 100), new Point(2600, 100), new Point(2700, 200), new Point(2720, 200), new Point(2740, 200)};
